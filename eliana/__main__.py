...
from eliana.modules import ALL_MODULES
from eliana import dispatcher, updater, LOGGER, TOKEN, tbot
from eliana.modules.helper_funcs.misc import paginate_modules
...
importlib.import_module("eliana.modules.tr_engine.language")

for module_name in ALL_MODULES:
    imported_module = importlib.import_module("eliana.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[
        InlineKeyboardButton(text=tld(chat.id, 'main_start_btn_support'),
                             url="http://telegram.me/MissEliana_BoT?startgroup=botstart")
    ]]
    keyboard += [[
