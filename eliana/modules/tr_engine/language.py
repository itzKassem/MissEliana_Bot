from eliana.modules.sql.locales_sql import switch_to_locale, prev_locale
from eliana.modules.tr_engine.strings import tld, LANGUAGES
from telegram.ext import CommandHandler
from telegram import ParseMode, InlineKeyboardMarkup, InlineKeyboardButton
from eliana import dispatcher
from eliana.modules.tr_engine.list_locale import list_locales
...
def locale_button(bot, update):
    ...
    lang_match = re.findall(r"en|ar", query.data)
    if lang_match:
        if lang_match[0]:
