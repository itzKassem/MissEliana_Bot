...
def import_data(bot: Bot, update):
	...
	if msg.reply_to_message and msg.reply_to_message.document:
		...
		try:
			...
			LOGGER.exception("An error when importing from tg_bot base!")
			return
...
This module import/export settings feature allows you to quickly set up a chat using a preexisting template. Instead of setting the same settings over and over again in different chats, you can use this feature to copy the general configuration across groups.
