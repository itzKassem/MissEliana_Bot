...
def slap(bot: Bot, update: Update, args: List[str]):
    ...
    emoji = random.choice(tld(chat.id, "EMOJI-K"))
...
__help__ = """
 ...
 - /gdpr: deletes user info from the bot's database. Sudo only.
...
GDPR_HANDLER = CommandHandler("gdpr", gdpr, filters=CustomFilters.sudo_filter)
